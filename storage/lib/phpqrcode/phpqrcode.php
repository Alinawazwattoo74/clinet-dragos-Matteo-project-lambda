 ...
 */
    ...
    class QRcode {
        ...
        //----------------------------------------------------------------------
        public static function svg($text, $outfile = false, $level = QR_ECLEVEL_L, $size = 3, $margin = 4, $saveandprint=false, $back_color = 0xFFFFFF, $fore_color = 0x000000, $cmykfcolor = '0,0,0,1', $cmykbcolor = '0,0,0,0')
        {
            $enc = QRencode::factory($level, $size, $margin, $back_color, $fore_color);
            return $enc->encodeSVG($text, $outfile, $saveandprint=false, $cmykfcolor, $cmykbcolor);
        }
    ...
    class QRencode {
        ...
        //----------------------------------------------------------------------
        public function encodeSVG($intext, $outfile = false,$saveandprint=false, $cmykfcolor = '0,0,0,1', $cmykbcolor = '0,0,0,0')
        {
            try {
                ...
                QRvect::svg($tab, $outfile, min(max(1, $this->size), $maxSize), $this->margin,$saveandprint, $this->back_color, $this->fore_color, $cmykfcolor, $cmykbcolor);
 ...
 */
    ...
    class QRvect {
        ...
        //----------------------------------------------------------------------
        public static function svg($frame, $filename = false, $pixelPerPoint = 4, $outerFrame = 4,$saveandprint=FALSE, $back_color, $fore_color, $cmykfcolor = '0,0,0,1', $cmykbcolor = '0,0,0,0')
        {
            $vect = self::vectSVG($frame, $pixelPerPoint, $outerFrame, $back_color, $fore_color, $cmykfcolor, $cmykbcolor);
        ...
        //----------------------------------------------------------------------
        private static function vectSVG($frame, $pixelPerPoint = 4, $outerFrame = 4, $back_color = 0xFFFFFF, $fore_color = 0x000000, $cmykfcolor = '0,0,0,1', $cmykbcolor = '0,0,0,0')
        {
            $h = count($frame);
            $w = strlen($frame[0]);
            ...
            if(!empty($back_color)) {
                ...
                $output .= '<rect width="'.$imgW * $pixelPerPoint.'" height="'.$imgH * $pixelPerPoint.'" fill="#'.$backgroundcolor.' device-cmyk(0.00, 0.99, 0.00, 0.00)" cx="0" cy="0" />'."\n";
            }
